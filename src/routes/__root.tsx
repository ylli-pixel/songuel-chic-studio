...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Hairbysonguel Studio offers professional hair services, balayage, and styling in Dübendorf, Switzerland." },
      { property: "og:description", content: "Hairbysonguel Studio offers professional hair services, balayage, and styling in Dübendorf, Switzerland." },
      { name: "twitter:description", content: "Hairbysonguel Studio offers professional hair services, balayage, and styling in Dübendorf, Switzerland." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f8beb383-ce63-40dc-8d16-676b4d4850a3/id-preview-46a6a8e6--4514c27d-a18d-4b9b-99d6-0b9d917bda2c.lovable.app-1783360636904.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f8beb383-ce63-40dc-8d16-676b4d4850a3/id-preview-46a6a8e6--4514c27d-a18d-4b9b-99d6-0b9d917bda2c.lovable.app-1783360636904.png" },
    ],
    links: [
