...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Willkommen bei Hairbysonguel – Ihrem modernen Coiffeur- und Beautysalon in Dübendorf. Persönlichkeit, Qualität und Präzision." },
      { property: "og:description", content: "Willkommen bei Hairbysonguel – Ihrem modernen Coiffeur- und Beautysalon in Dübendorf. Persönlichkeit, Qualität und Präzision." },
      { name: "twitter:description", content: "Willkommen bei Hairbysonguel – Ihrem modernen Coiffeur- und Beautysalon in Dübendorf. Persönlichkeit, Qualität und Präzision." },
